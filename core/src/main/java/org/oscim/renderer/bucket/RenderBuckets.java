...
public class RenderBuckets extends TileData {
    ...
    public LineBucket addLineBucket(int level, LineStyle style) {
        LineBucket l = (LineBucket) getBucket(level, LINE, null);
        if (l == null)
            return null;
    ...
    public PolygonBucket addPolygonBucket(int level, AreaStyle style) {
        PolygonBucket l = (PolygonBucket) getBucket(level, POLYGON, null);
        if (l == null)
            return null;
        l.area = style;
        return l;
    ...
    public MeshBucket addMeshBucket(int level, AreaStyle style) {
        MeshBucket l = (MeshBucket) getBucket(level, MESH, null);
        if (l == null)
            return null;
        l.area = style;
        return l;
    ...
    public CircleBucket addCircleBucket(int level, CircleStyle style) {
        CircleBucket l = (CircleBucket) getBucket(level, CIRCLE, null);
        if (l == null)
            return null;
        l.circle = style;
        return l;
    ...
    public RenderBucket addDefaultBucket(int level, DefaultBucket defaultBucket) {
        RenderBucket l = getBucket(level, DEFAULT, defaultBucket);
        if (l == null)
            return null;
        return l;
    }
    ...
    public LineBucket getLineBucket(int level) {
        return (LineBucket) getBucket(level, LINE, null);
    }
    ...
    public MeshBucket getMeshBucket(int level) {
        return (MeshBucket) getBucket(level, MESH, null);
    }
    ...
    public PolygonBucket getPolygonBucket(int level) {
        return (PolygonBucket) getBucket(level, POLYGON, null);
    }
    ...
    public LineTexBucket getLineTexBucket(int level) {
        return (LineTexBucket) getBucket(level, TEXLINE, null);
    }
    ...
    public HairLineBucket getHairLineBucket(int level) {
        return (HairLineBucket) getBucket(level, HAIRLINE, null);
    }
    ...
    public CircleBucket getCircleBucket(int level) {
        return (CircleBucket) getBucket(level, CIRCLE, null);
    }
    ...
    private RenderBucket getBucket(int level, int type, DefaultBucket defaultBucket) {
        ...
        if (bucket == null) {
            ...
            if (type == LINE)
                ...
                bucket = defaultBucket.getNewInstance(level);
    ...
    private int countVboSize() {
        ...
        for (RenderBucket l = buckets; l != null; l = l.next) {
            if (l.type == DEFAULT) {
                int cnt = ((DefaultBucket) l).getVertexShortCnt();
                vboShorts += l.numVertices * cnt;
            } else {
